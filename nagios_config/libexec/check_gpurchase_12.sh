...
curl 'http://14.152.121.136:11280/solr/gpurchase/replication?command=details&wt=json' -o $url_log -s
...
result="master_gpurchase:$master_indexversion slave12_gpurchase:$slave12_indexversion"
