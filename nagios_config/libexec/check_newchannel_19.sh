...
curl 'http://202.104.208.170:11980/solr/newchannel/replication?command=details&wt=json' -o $url_log -s
...
result="master_newchannel:$master_indexversion slave19_newchannel:$slave19_indexversion"
