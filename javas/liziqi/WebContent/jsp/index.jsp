...
<html  >
   ...
   <body style="background-color:##F0F0F0;transform:scale(0.98); background-attachment:fixed; height:100%">
   <!--  导航部门  -->
      <div class="container">
         <div class="row">
            <div class="col-md-6">
	...
	<div class="tab-pane fade" id="remen">
		...
		<p>热门...............</p>
			...
			<% %>
            	...
            	<div style="background-color:#096; z-index:999; position:fixed; bottom:0; left:0; width:100%; _position:absolute;
 _top: expression_r(documentElement.scrollTop + documentElement.clientHeight-this.offsetHeight); overflow:visible;"><p>我是底部...........</p></div> 
