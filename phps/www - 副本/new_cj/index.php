...
if (array_key_exists("username",$_SESSION)) {
	...
	header("location:/new_cj/admin_login.php");
...
<html lang="zh-CN">
   <head>
      ...
      <!-- 引入 Bootstrap -->
      <link href="/new_cj/static/bootstrap.min.css" rel="stylesheet">

        <link rel="stylesheet" href="/new_cj/static/jquery-confirm.min.css">
   </head>
   <body>
...
<div>
      ...
      <script src="/new_cj/static/jquery.js"></script>

      <script src="/new_cj/static/bootstrap.min.js"></script>

<script src="/new_cj/static/jquery-confirm.min.js"></script>
...
<script>
  ...
  function cj_chaxun(id){
   ...
   $.ajax({url:'/new_cj/fenshu_chaxun.php',error:function(xhr){
 ...
 function cj_chaxun2(){
    ...
    $.ajax({url:'/new_cj/cj_chaxun.php',error:function(xhr){
